...
%   - Supports both sufficient statistic-based / free ABC
%
...
% a function for measuring the similarity of drawn pseudo data and the observations
...
for j=1:num_latent_draws
    ...
    % call similarity measure function
